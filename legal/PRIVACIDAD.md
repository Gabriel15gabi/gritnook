...
La app se sirve siempre por conexión cifrada (HTTPS), y todo lo que va y viene de
tu cuenta viaja cifrado también. En el servidor, **cada cuenta solo puede leer y
escribir lo suyo**: no lo decide la app, que es código que cualquiera puede
tocar, sino la propia base de datos. Las contraseñas se guardan cifradas de forma
...
Si cambia algo —que se añada una función que guarde datos nuevos, o que cambie
el proveedor de IA o el del servidor— se actualiza este texto, se cambia la fecha
de arriba y se avisa dentro de la aplicación.
