...
[aviso legal](AVISO-LEGAL.md) y el [aviso sobre la IA](IA.md).

## 2. Qué hace la aplicación

GritNook te ayuda a organizar los estudios: apuntar asignaturas, notas y faltas,
ver qué te falta para aprobar, llevar la agenda de entregas y exámenes, tomar
apuntes, guardar documentos y estudiar con un profe que funciona con inteligencia
artificial.

Es una herramienta de apoyo. **No sustituye a tu centro, a tu profesorado ni a las
normas de tu ciclo.**
...
siendo tuyo y descargable en cualquier caso.
...
- copiar, distribuir o vender el código, ni entero ni a trozos;
- quitar el nombre, el logotipo o los avisos de autoría;
- usarla para montar un servicio parecido;
- entrar por donde no toca, saltarte límites o hacerle ingeniería inversa más allá
...
envía al proveedor de IA cuando le preguntas, porque si no, no podría responderte.
...
médicos de nadie), ni nada que pueda dañar la aplicación o a quien la use.
...
- **Puede equivocarse.** Comprueba siempre las fechas, las fórmulas y cualquier
  cosa que te juegues.
- No es asesoramiento médico, legal ni financiero, y no atiende emergencias.
- Está para que aprendas y apruebes, no para hacerte los trabajos. Copiar lo que
...
mantenimiento, por cambios o porque falle un proveedor.
...
lo permita, no responde de:

- la pérdida de datos por borrar el navegador, perder el dispositivo o no hacer
  copias;
- las consecuencias de fiarse de un cálculo o de una respuesta del profe sin
  comprobarla;
- los fallos de servicios de terceros de los que depende la aplicación.
...
que diga la ley y, si eres consumidor, los de tu domicilio. También puedes acudir
