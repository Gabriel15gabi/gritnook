...
| `casos-cuentas.js` | **Las cuentas**, contra un Supabase de mentira que se porta como el de verdad: crear cuenta y entrar (con sus errores en castellano), olvidar la contraseña, que lo tuyo suba y llegue a otro dispositivo, que lo pendiente no se pise, sin conexión y al volver, tokens que caducan, «Mantener la sesión iniciada» (marcada, desmarcada, al cerrar la pestaña y al volver a abrir en un ordenador compartido), salir, cambiar de persona en el mismo navegador, borrar la cuenta, entrar con Google o GitHub (los botones solo si están encendidos, el secreto PKCE que no sale del navegador, la vuelta que da la sesión, el código sin su secreto o repetido que no sirve, cancelar y el secreto caducado), y el panel del creador: que solo lo vea él y que no enseñe el contenido de nadie |
