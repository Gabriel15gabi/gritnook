...
**726 pruebas.** Sin ventana pasan 720 y 6 se quedan en pendiente: son las que
dibujan un PDF, y sin tarjeta gráfica eso tarda demasiado. Abriendo
`pruebas/pruebas.html` en un navegador normal pasan las 726.
